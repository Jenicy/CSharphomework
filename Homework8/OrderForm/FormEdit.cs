...
namespace OrderForm {
  public partial class FormEdit : Form {
    ...
    public FormEdit() {
      ...
      customerBindingSource.Add(new Customer("zx1"));
      customerBindingSource.Add(new Customer("zx2"));
      goodsBindingSource.Add(new Goods("apple", 5.59f));
      goodsBindingSource.Add(new Goods("egg", 4.99f));
      goodsBindingSource.Add(new Goods("milk", 69.9f));
    }
